...
function _post(data,url) {
    //先提交文字，然后在session中获得answerId
...
function addPopEvent(func) {
    var oldonload = window.onpopstate;//得到上一个onload事件的函数
    if (typeof window.onpopstate != 'function') {//判断类型是否为'function',注意typeof返回的是字符串
